                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <td><?php echo $i++; ?></td>
                                ...
                                <div class="row">
                                    <div class="col">
                                    <a href="?page=peminjaman_ubah&&id=<?= $data['id_peminjaman']; ?>" class="btn btn-success" style=" border-radius: 20px;">Ubah</a>
                                    </div>
                                    <div class="col">
                                    ...
                                    <form method="post" action="simpan_koleksi.php" style="">
                                            ...
                                            <button type="submit" name="simpan" class="btn btn-info" style="border-radius: 20px;" onclick="return confirm('Apakah anda yakin menyimpan data ini?');">simpan</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
